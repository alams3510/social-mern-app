    ...
    <div className="shareContainer">
      <div className="shareWrapper">
        <div className="shareTop">
          <img src={user.profilePicture?PF+user.profilePicture:PF+"/person/noAvatar.png"} alt="img" className="shareImg" />
          <input ref={desc} type="text" className="shareText" placeholder={`What's in your Mind ${user.username} ?`} />
        </div>
        ...
        <div className="shareMid">
          ...
          <div className="shareImgContainer">
                        <span className="shareCancelImg" onClick={() => setFile(null)} >X</span>
        ...
        <form className="shareDown" onSubmit={submitHandler}>
          <div className="shareOptions">
            <div className="photoUpload">
              ...
              <label htmlFor="file" className="uploadText">Photo or Video</label>
